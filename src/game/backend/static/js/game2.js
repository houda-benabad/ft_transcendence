...
function update_coordinates(gameBodies, coordinates) {
	...
	ball.position.x = coordinates.ball.x;
	ball.position.z = coordinates.ball.z;
	const { player, otherPlayer } = gameBodies;
	player.position.x = coordinates.player.x;
	player.position.z = coordinates.player.z;

	otherPlayer.position.x = coordinates.otherPlayer.x;
	otherPlayer.position.z = coordinates.otherPlayer.z;
}
