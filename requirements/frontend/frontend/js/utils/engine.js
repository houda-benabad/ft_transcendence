...
export default class Engine {
	...
	setupSocket(  ) {
		let url = `wss://${window.location.host}/wss/${this.mode}/1`
		// let url = `wss://${window.location.host}/wss/${this.mode}/${_tokenService.accessToken}`
		// _tokenService.accessToken
		return new WebSocket( url)
		// return new WebSocket( url, _tokenService.accessToken )
	}
