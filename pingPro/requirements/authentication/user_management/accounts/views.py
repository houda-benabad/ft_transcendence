...
intraAuthUrl = f"https://api.intra.42.fr/oauth/authorize?client_id={UID}&redirect_uri=http%3A%2F%2Flocalhost%2Fapi%2Foauth2%2Flogin%2Fredirect&response_type=code"
...
def exchangeCode(code: str):
    data = {
        ...
        "code": code,
        "redirect_uri": "http://localhost/api/oauth2/login/redirect",
        "scope": "public"
    }
    headers = {
